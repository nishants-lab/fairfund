      ...
      <div className="flex items-center gap-1 text-xs font-medium uppercase tracking-wide text-faint">
        ...
        {hint && (
          <span className="group relative cursor-help">
            ...
            <span className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-1 hidden w-64 -translate-x-1/2 rounded-lg bg-ink px-3 py-2 text-xs font-normal normal-case leading-relaxed text-white shadow-lg group-hover:block dark:bg-slate-700">
              {hint}
            </span>
          </span>
        )}
